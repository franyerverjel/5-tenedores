      ...
      uploadImageStorage(imagesSelected).then(arrayImages => {
        db.collection("restaurants")
          ...
          .catch(error => {
            ...
            setIsLoading(false);
            toastRef.current.show(
              "Error al subir el restaurante, inténtalo de nuevo"
            );
          });
      });
    }
...
function UploadImage(props) {
  ...
  const imageSelect = async () => {
    ...
    if (resultPermissionCamera === "denied") {
      toastRef.current.show(
        "Es necesario aceptar los permisos de la galería, si los has rechazado debes ir a Ajustes y activarlos manualmente",
        4000
      );
    } else {
...
function Map(props) {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (status !== "granted") {
        toastRef.current.show(
          "Tienes que aceptar los permiso de localización",
          3000
        );
      } else {
      ...
      <View>
        ...
        <View style={styles.viewMapBtn}>
          <Button
            ...
            containerStyle={styles.vieMapBtnContainerSave}
            buttonStyle={styles.viewMapBtnSave}
          />
          <Button
            title="Cancelar ubicación"
            onPress={() => setIsVisibleMap(false)}
            containerStyle={styles.vieMapBtnContainerCancel}
...
const styles = StyleSheet.create({
  ...
  vieMapBtnContainerSave: {
    paddingRight: 5
  },
  viewMapBtnSave: {
    backgroundColor: "#00a680"
  },
  vieMapBtnContainerCancel: {
    paddingLeft: 5
  },
  viewMapBtnCancel: {
